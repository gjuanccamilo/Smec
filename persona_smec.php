...
<!-- HEADER -->
    ...
    <script>
        function preguntar(valor){
            ...
            if (eliminar)
            window.location.href="eliminarpersona.php?code="+valor;
        }
</script>
...
if($catica){
    $sql = "SELECT identificacion,nombres,apellidos,correo,fecha_nacimiento,fecha_creacion_usuario,telefono,direccion,tipo_persona,ciudad_nacimiento,password,foto,fecha_actualizacion,genero FROM persona where nombres LIKE '%$catica%'"; 
}
else{
    $sql = "SELECT identificacion,nombres,apellidos,correo,fecha_nacimiento,fecha_creacion_usuario,telefono,direccion,tipo_persona,ciudad_nacimiento,password,foto,fecha_actualizacion,genero FROM persona"; 
}
            ...
            <tbody>";
                while ($fila=mysqli_fetch_array($matriz,MYSQLI_ASSOC)){
                    echo "<tr>";
                        ...
                        echo"<td>".$fila['fecha_creacion_usuario']."</td>";
                        echo"<td>".$fila['telefono']."</td>";
                        echo"<td>".$fila['direccion']."</td>";
                        echo"<td>".$fila['tipo_persona']."</td>";
                        echo"<td>".$fila['ciudad_nacimiento']."</td>";
                        echo"<td>".$fila['password']."</td>";
                        echo"<td>";echo"<img src='".$fila['foto']."'width='150'>";
                        echo"<td>".$fila['fecha_actualizacion']."</td>";
                        echo"<td>".$fila['genero']."</td>";
                        echo"<td><a href='conexion_editar.php?sala=" .$fila['identificacion']."'>Editar</a></td>";
                        echo "<td><a href='javascript:preguntar(\"".$fila['identificacion']."\")'>Eliminar</a></td>";
                    echo "</tr>";
                }
                echo"
            </tbody>
...
<!-- FOOTER -->
    <footer>
        <span class="footer-title">Derechos Reservados GlowSmec</span>
