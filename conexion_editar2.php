<html>
    ...
    <div class="nav-buttons">
        ...
        <main>
        <form action="conexion_sql2.php" method="POST">
        ...
        $matriz = mysqli_query($basededatos,"SELECT cod_ciudad, descripcion FROM ciudad where cod_ciudad ='".$vcodigo."' ;");
            ...
            echo "<label>Codigo de la ciudad:</label>";
            echo "<input type='text' id='cod_ciudad' name='cod_ciudad' value=".$vcodigo." readonly><br><br>";
        ...
        <a href="ciudadsmec.php" class="boton">Volver a la lista de ciudades</a>
        </form>
</main>
