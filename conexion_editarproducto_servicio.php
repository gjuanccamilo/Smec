...
<style>
    ...
    <div class="nav-buttons">
        ...
        <form action="conexion_editarproducto_servicio_sql.php" method="POST" enctype="multipart/form-data">
        ...
        $matriz = mysqli_query($basededatos,"SELECT cod_prod_ser,descripcion,tipo_prod_ser, fecha_creacion, genero_servicio, precio, clasificacion,foto FROM producto_servicio where cod_prod_ser ='".$vcodigo."' ;");
        ...
        echo "<label>cod_prod_ser:</label>";
        echo "<input type='text' id='cod_prod_ser' name='cod_prod_ser' value='".$fila['cod_prod_ser']."'><br><br>";
        ...
        echo "<label for='tipo_prod_ser'>Tipo producto-servicio:</label>";
        echo "<input type='text' id='tipo_prod_ser' name='tipo_prod_ser' value='".$fila['tipo_prod_ser']."'><br><br>";

        echo "<label for='fecha_creacion'>fecha_creacion:</label>";
        echo "<input type='date' id='fecha_creacion' name='fecha_creacion' value='".$fila['fecha_creacion']."'><br><br>";

        echo "<label for='genero_servicio'>genero_servicio:</label>";
        echo "<input type='text' id='genero_servicio' name='genero_servicio' value='".$fila['genero_servicio']."'><br><br>";


        echo "<label for='precio'>precio:</label>";
        echo "<input type='text' id='precio' name='precio' value='".$fila['precio']."'><br><br>";

        echo "<label for='clasificacion'>clasificacion:</label>";
        echo "<input type='text' id='clasificacion' name='clasificacion' value=''><br><br>";
        ...
        <input type="submit" value="Actualizar codigo producto servicio">
        <a href="producto_servicio.php" class="boton" >Volver a la lista de productos o servicios</a>
        </form>
</main>
