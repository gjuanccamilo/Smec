...
<style>
    ...
    <div class="nav-buttons">
        ...
        <form action="conexion_sql_factura.php" method="POST">
        ...
        $matriz = mysqli_query($basededatos,"SELECT no_factura, cliente, fecha, notas FROM factura where no_factura ='".$vcodigo."' ;");
        ...
        echo "<label>Codigo de factura:</label>";
        echo "<input type='text' id='no_factura' name='no_factura' value=".$vcodigo." readonly><br><br>";


        echo "<label for='cliente'>Cliente:</label>";
        //echo "<input type='text' id='cliente' name='cliente' value=".$fila['cliente']."><br><br>";
        try {
            // Ejecutando sql
        ...
        echo "<input type='date' id='fecha' name='fecha' value=".$fila['fecha']."><br><br>";

        echo "<label for='notas'>Notas:</label>";
        echo "<input type='text' id='notas' name='notas' value=".$fila['notas']."><br><br>";
        ...
        <a href="factura_smec.php" class="boton">Volver a la lista de facturas</a>
        </form>
</main>
