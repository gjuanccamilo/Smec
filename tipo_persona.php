...
<!-- HEADER -->
    ...
    <script>
        function preguntar(valor){
            ...
            if (eliminar)
            window.location.href="eliminartipopersona.php?code="+valor;
        }
</script>
<body>
    <!--Buscador-->
...
<form class="search-container" action="tipo_persona.php" method="GET">
    ...
    <?php
    //codigo para la base de datos conectarme
...
if($catica){
    $sql = "SELECT cod_tipo_persona, descripcion FROM tipo_persona where cod_tipo_persona LIKE '%$catica%'"; 
}
else{
    $sql = "SELECT cod_tipo_persona, descripcion FROM tipo_persona"; 
}
        ...
        echo"<table>
            ...
            <tbody>";
                while ($fila=mysqli_fetch_array($matriz,MYSQLI_ASSOC)){
                    echo "<tr>";
                        echo"<td>".$fila['cod_tipo_persona']."</td>";
                        echo"<td>".$fila['descripcion']."</td>";
                        echo"<td><a href='conexion_editar_tipo_persona.php?sala=" .$fila['cod_tipo_persona']."'>Editar</a></td>";
                        echo "<td><a href='javascript:preguntar(\"".$fila['cod_tipo_persona']."\")'>Eliminar</a></td>";
