...
<body>
    <header>
        ...
        function preguntar(valor){
            ...
            if (eliminar)
            window.location.href="eliminargenero.php?code="+valor;
        }
</script>
...
<br>
<br>
<form class="search-container" action="genero_smec.php" method="GET">
            <label name ="busqueda">Buscar</label>
            <input type="text" name="busqueda" placeholder="Buscar por el codigo de genero.." value="">
            <button type="submit">Buscar</button>
            <a href="insert_genero_forma.php">
...
if($catica){
    $sql = "SELECT cod_genero,descripcion FROM genero where cod_genero LIKE '%$catica%'"; 
}
else{
    $sql = "SELECT cod_genero,descripcion FROM genero"; 
}
        ...
        echo"<table>
            ...
            <tbody>";
                while ($fila=mysqli_fetch_array($matriz,MYSQLI_ASSOC)){
                    echo "<tr>";
                        echo"<td>".$fila['cod_genero']."</td>";
                        echo"<td>".$fila['descripcion']."</td>";
                    echo "<td><a href='conexion_editargenero.php?catica=" . $fila['cod_genero'] . "'>Editar</a></td>";
                        echo "<td><a href='javascript:preguntar(\"".$fila['cod_genero']."\")'>Eliminar</a></td>";
                }
                echo"
            </tbody>
        </table>";
