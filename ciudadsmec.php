...
<br>
<br>
<form class="search-container" action="ciudadsmec.php" method="GET">
            <label name ="busqueda">Buscar</label>
            <input type="text" name="busqueda" placeholder="Buscar por el nombre de ciudad.." value="">
            <button type="submit">Buscar</button>
            <a href="insert_ciudad.php">
...
if($catica){
    $sql = "SELECT cod_ciudad, descripcion FROM ciudad where descripcion LIKE '%$catica%'"; 
}
else{
    $sql = "SELECT cod_ciudad, descripcion FROM ciudad"; 
}
        ...
        echo"<table>
            ...
            <tbody>";
                while ($fila=mysqli_fetch_array($matriz,MYSQLI_ASSOC)){
                    echo "<tr>";
                        echo"<td>".$fila['cod_ciudad']."</td>";
                        echo"<td>".$fila['descripcion']."</td>";
                        echo"<td><a href='conexion_editar2.php?sala=" .$fila['cod_ciudad']."'>Editar</a></td>";
                        echo "<td><a href='javascript:preguntar(\"".$fila['cod_ciudad']."\")'>Eliminar</a></td>";
                    echo "</tr>";
                }
                echo"
            </tbody>
