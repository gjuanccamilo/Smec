...
<header>
    ...
    <h1>Insertar tipo persona</h1>
</header>

<main>
<form action= "insert_tipo_persona_sql.php" method="POST">
...
<?php
     ...
     try {
        ...
        echo "<label>Codigo tipo persona:</label>";
        echo "<input type='text' id='cod_tipo_persona' name='cod_tipo_persona' value=''><br><br>";
