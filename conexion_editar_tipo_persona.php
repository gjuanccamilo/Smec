<html>
    ...
    <div class="nav-buttons">
        ...
        <h1> Editar Tipo Persona </h1>
</header>
    
    <body>
        <main>
        <form action="conexion_sql_tipo_persona.php" method="POST">
        ...
        $matriz = mysqli_query($basededatos,"SELECT cod_tipo_persona, descripcion FROM tipo_persona where cod_tipo_persona ='".$vcodigo."' ;");
        ...
        echo "<label>Codigo de tipo persona:</label>";
        echo "<input type='text' id='cod_tipo_persona' name='cod_tipo_persona' value=".$vcodigo." readonly><br><br>";
        ...
        <input type="submit" value="Actualizar tipo persona">
        <a href="tipo_persona.php" class="boton">Volver a la lista de tipo persona</a>
    </form>
</main>
